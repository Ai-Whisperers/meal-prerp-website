...
> Plan Hogar 🏠 no disponible a escala actual.

---

## Plan Sugerido

**Plan 40 Tier Completo** — Gs. 1.600.000/mes.

- 40 comidas/mes (5 días × 2 comidas durante 4 semanas)
- Cubre lunes a viernes; los fines de semana cocina/come afuera
- Precio efectivo: Gs. 40.000/comida

---

## Desglose de Gs. 1.600.000 (Plan 40 Completo)

| Componente | % | Gs. |
|---|---|---|
| 🥩 Ingredientes | 54,2% | 867.200 |
| 👨‍🍳 Chef (sueldo + comisión) | 21,8% | 348.800 |
| 🛒 Comprador (sueldo + auto + comisión) | 14,3% | 228.800 |
| 🏠 Gas/luz/packaging/amortiz. | 4,0% | 64.000 |
| 🏦 Reserva empresa | 5,7% | 91.200 |
| **TOTAL** | **100%** | **1.600.000** |
...
| Desayuno upgrade (20 un) | 400.000 |
| Fermentados (2 frascos) | 80.000 |

---

## Roadmap de Precio si Seguimos Creciendo

| Escala | Plan 40 Completo | Ahorro |
|---|---|---|
| Hoy (5 clientes) | 1.600.000 | — |
| 20 clientes | 1.280.000 | -20% |
| 60 clientes | 1.120.000 | -30% |
...
Ver análisis completo en `_archivo/pricing-model-v3/07_Meal_Prep_Pricing_Model/12_Comparativa_Valor_Cliente.md`.
...
- [ ] Plan: 20/40/60/90
- [ ] Tier: Completo (40k/comida) o Premium (55k/comida)
- [ ] Alergias / intolerancias
- [ ] Proteínas favoritas
- [ ] Carbohidrato preferido (arroz / mandioca / papa / pasta)
- [ ] Menús a evitar
