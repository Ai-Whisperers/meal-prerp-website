...
- **[operador-edu/01_Operaciones_Cocina/02_Cuestionario_Chef.md](../../operador-edu/01_Operaciones_Cocina/02_Cuestionario_Chef.md)** 📋 — Texto para mandar al Chef candidato
- **[operador-edu/02_Logistica_y_Compras/03_Cuestionario_Comprador.md](../../operador-edu/02_Logistica_y_Compras/03_Cuestionario_Comprador.md)** 📋 — Texto para mandar al Comprador + Auto candidato
...
1. **Confirmar planes elegidos** con cada cliente (ver `clientes/activos/*/00_Perfil_y_Factura.md`).
