...
[`07_Client_Experience_CRM/01_Formulario_Onboarding.md`](../../07_Client_Experience_CRM/01_Formulario_Onboarding.md).
...
**Ejemplo:** ver ficha de clientes actuales en [`09_Active_Clients/`](../../09_Active_Clients/).
...
- Formulario de onboarding base: [`../../07_Client_Experience_CRM/01_Formulario_Onboarding.md`](../../07_Client_Experience_CRM/01_Formulario_Onboarding.md)
- Manual de bienvenida (regeneración): [`../../07_Client_Experience_CRM/02_Manual_Bienvenida_Cliente.md`](../../07_Client_Experience_CRM/02_Manual_Bienvenida_Cliente.md)
- Fichas de clientes activos: [`../../09_Active_Clients/`](../../09_Active_Clients/)
