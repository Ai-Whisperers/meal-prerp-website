...
- **Materiales de marketing / onboarding:** [`marketing/03_Campana_HelloFresh_Local/`](../marketing/03_Campana_HelloFresh_Local/)
...
## 2. Verticales de Expansión

_Cómo escalamos más allá de vender nuestro tiempo._

### 🦴 Productos Propios (Waste-to-Premium)

Convertir desperdicios en productos de lujo.

- **Línea Mascotas (BARF):** Recortes y huesos.
- **Línea Gourmet:** Caldos, Grasas, Fermentos.
- **Insumos B2B:** Mise-en-place para restaurantes.
- _Ver carpeta:_ `02_Verticales_de_Expansion/01_Productos_Propios/`

### 🎓 Servicios y Experiencias

Monetizar el conocimiento y la comunidad.

- **Academia:** Talleres de Desposte y Fermentos.
- **Eventos:** Cenas Exclusivas ("La Cena de la Vela").
- **Comunidad:** Compras mayoristas colaborativas.
- _Ver carpeta:_ `02_Verticales_de_Expansion/02_Servicios_y_Experiencias/`

### 🤝 Alianzas Corporativas

Ventas B2B2C.

- **Nutricionistas:** Cocina por prescripción.
- **Regalos Corp:** Canastas sostenibles.
- _Ver carpeta:_ `02_Verticales_de_Expansion/03_Alianzas_Corporativas/`

---

## 3. Resumen Financiero Global

¿Cuánto dinero puede generar todo el ecosistema junto?

- **[Ver Proyección Global](03_Proyeccion_Financiera_Global.md)** (Core + Verticales).

---

## 4. Inteligencia de Mercado (Recursos Estratégicos)

_Herramientas para comprar mejor y vender mejor._

- **[Calendario Estacional](..\05_Market_Intelligence\07_Calendario_Estacional_Paraguay.md):** Qué comprar barato cada mes.
- **[Directorio Proveedores Abasto](..\05_Market_Intelligence\08_Directorio_Proveedores_Abasto.md):** "El Libro Negro" de puestos específicos.
- **[Análisis de Competencia](..\05_Market_Intelligence\10_Analisis_Competencia_Delivery.md):** Estrategia vs PedidosYa.
- **[Requisitos Legales](..\05_Market_Intelligence\11_Requisitos_Legales_INAN.md):** Roadmap al R.S.P.A.

---

## 5. Perfiles de Cliente (Target)

| Perfil              | Ubicación      | Necesidad Principal  | Producto Ideal                |
| :------------------ | :------------- | :------------------- | :---------------------------- |
| **Estudiante UNA**  | Campus San Lo  | Energía Barata       | Packs de Estudio / Microondas |
| **Médico Clínicas** | Hospital       | Comida Limpia/Rápida | Guardia Survival Kit          |
| **Commuter**        | Ruta 1 y 2     | Cena al llegar       | Crockpot Bags / Freezer Meals |
| **Remoto Global**   | Home Office    | Salud y Tiempo       | Servicio Completo (Nivel 3)   |
| **La Abuela**       | Barrios viejos | Ayuda Física         | Servicio Prep (Nivel 2)       |
