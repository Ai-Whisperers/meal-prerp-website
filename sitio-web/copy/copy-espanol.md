...
> Implementación: `web/app/page.tsx` (repo raíz).  
...
**Nota código:** el MVP actual en `web/app/page.tsx` aún usa hero mise; al implementar, priorizar § Hero (Fuego Lento) abajo.
...
Comidas cocinadas, selladas al vacio, congeladas. Listas para regenerar (baño maria / micro / horno). Ver [`operaciones/logistica-empaque/entrega/metodos-entrega-regeneracion.md`](../operaciones/logistica-empaque/entrega/metodos-entrega-regeneracion.md).
...
*(Platos: rotacion desde `negocio/programa-operador/catalogo/catalogo-menu-rotacion.md` — actualizar semanalmente)*
