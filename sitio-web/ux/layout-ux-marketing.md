...
**Estado código:** `web/app/page.tsx` = MVP mise-only · **objetivo** = alinear con este plan (Fuego Lento hero).  
...
**Gap código:** `web/app/page.tsx` usa Playfair + Lato — migrar a brand doc.
...
| En plan | En `web/app/page.tsx` hoy |
|---------|----------------------|
