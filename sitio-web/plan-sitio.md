...
| **Código sitio** | Raíz del repo — `app/`, `npm run dev` → `http://localhost:3000` |
| **Deploy** | [prep.paragu-ai.com](https://prep.paragu-ai.com) · Docker `docker-compose.yml` puerto 3010 |
...
| | Documentación (objetivo) | Código `app/page.tsx` (hoy) |
|--|-------------------------|----------------------------|
...
| 8 | Calculadora | `01_Copy` + lógica existente en `app/` |
...
Plantilla mensajes: [`marketing/Mensaje_Valor_Cliente_Template.md`](../marketing/Mensaje_Valor_Cliente_Template.md)
...
8. Implementar layout plan en `app/page.tsx`  
