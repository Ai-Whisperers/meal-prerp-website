...
Consolidates decisions from the May 2026 planning session. Use with `docs/INDEX.md`.
...
**Monorepo layout:** numbered doc folders + `app/` at root for the landing.
...
- Liquids: “ice brick” HDPE bags (see `operaciones/logistica-empaque/especificaciones-empaque.md`)

**Do not merge** mise (Nivel 2) and freezer (Nivel 3) into one packaging or one reheat card.

Full analysis: `operaciones/logistica-empaque/metodos-entrega-regeneracion.md`
...
- **Master story:** “El domingo que te devuelve el martes” — `marketing/04_Story_Sales_Narrative.md`
...
- **Gap:** current `app/page.tsx` is mise-only; plan requires Fuego Lento hero + product picker

Full spec: `sitio-web/layout-ux-marketing.md`
...
|------|------------------|
| Hero = Fuego Lento | `01_Copy_ES_Spanish.md`, `app/page.tsx` |
